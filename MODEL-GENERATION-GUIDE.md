...
این عملیات حدود 5-10 دقیقه طول می‌کشد و تصاویر زیر را تولید می‌کند:
- 5 مدل زن (35 ساله)
- 5 مدل مرد (35 ساله)
- 5 مدل دختر (13-15 ساله)
- 5 مدل پسر (13-15 ساله)

جمعاً 20 مدل AI تولید می‌شود.
...
2. **هزینه API**: هر تصویر مدل از API Gemini استفاده می‌کند. برای 20 مدل، حدود 20 درخواست به API ارسال می‌شود.
...
2. از منوی dropdown یک دسته‌بندی انتخاب می‌کند (زن، مرد، دختر، پسر)
3. یکی از 5 مدل آن دسته را انتخاب می‌کند
4. یک پس‌زمینه انتخاب می‌کند
5. سیستم تصویری حرفه‌ای از مدل با لباس انتخابی در پس‌زمینه مورد نظر تولید می‌کند

### دسته‌بندی مدل‌ها:
- **زن**: 5 مدل زن 35 ساله با استایل‌های مختلف
- **مرد**: 5 مدل مرد 35 ساله با ظاهرهای متنوع
- **دختر**: 5 مدل دختر نوجوان 13-15 ساله
- **پسر**: 5 مدل پسر نوجوان 13-15 ساله
